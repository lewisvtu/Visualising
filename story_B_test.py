...
# #     direc_Of_travel = direc_Of_travel / np.linalg.norm(direc_Of_travel, axis=1)[:,None]
...
# frame, ts, xs, ys, zs, b1,b2,b3,b4,b5,b6,b7,b8,b9 = np.loadtxt("timeStoped1234.txt", unpack=True)
# path_of_cam =  np.loadtxt("timeStoped1234.txt")
